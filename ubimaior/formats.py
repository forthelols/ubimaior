...
_Token = collections.namedtuple(
    "Token", ["line", "scope", "indent_lvl", "obj_type", "continuation"]
)
    ...
    if isinstance(obj, ubimaior.OverridableMapping):
        tokens.append(
            _Token(
                ...
                obj_type=TokenTypes.DICTIONARY_START,
                continuation=False,
            )
        )
        ...
        tokens.append(
            _Token(
                ...
                scope=scope,
                indent_lvl=indent_lvl,
                obj_type=TokenTypes.DICTIONARY_END,
                continuation=True,
            )
        )
        ...
        tokens.append(
            _Token(
                ...
                scope=scope,
                indent_lvl=indent_lvl,
                obj_type=TokenTypes.LIST_START,
                continuation=False,
            )
        )
...
try:
    ...
    class TomlFormatter(Dumper, Loader, PrettyPrinter):
        ...
        def current_key(self):
            ...
            return ".".join(
                [str(x.line) for x in self._token_stack] + [str(self._current_attribute.line)]
            )
